let vsSource =
    [
        ...
        'varying vec3 v_surfaceToLight;', //направление падающего света
        'varying vec3 v_surfaceToView;',  // вектор от точки до наблюдателя
        ...
        '                       specular = pow(max(dot(v_normal, halfVector), 0.0), u_shininess);',
                        ...
                        '    if (lambertian > ToonThresholds[0])',
                        '    {',
                        '        color *= ToonBrightnessLevels[0];',
                        '    }',
                        '    else if (lambertian > ToonThresholds[1])\n',
                        '    {',
                        '        color *= ToonBrightnessLevels[1];',
                        '    }',
                        '    else if (lambertian > ToonThresholds[2])',
                        '    {',
                        '        color *= ToonBrightnessLevels[2];',
                        '    }',
                        '    else if (lambertian > ToonThresholds[3])',
                        '    {',
